    ...
    <div className="flex items-center justify-between animate-move-up min-h-[60vh] flex-col-reverse gap-10 lg:gap-0 lg:flex-row">
      <div className="space-y-10 text-center lg:text-left">
        ...
        <p className="md:w-96 text-lg text-gray-300">
          {
            "I'm a Skilled Frontend Developer building with modern web applications."
          }
        </p>
        <Link
          href={"mailto:rahulbhati0202@gmail.com"}
      ...
      <div className="relative">
        ...
        <div className="absolute bottom-5 sm:bottom-16 left-0 sm:-left-10">
          <Link
            href={
              "https://drive.google.com/file/d/17XP5PdsbrfDbpTOiGC5-Z72tpotcufF_/view?usp=drive_link"
            }
            target="_blank"
            download
          >
